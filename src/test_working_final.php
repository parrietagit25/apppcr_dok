...
try {
    ...
    // Código más corto para evitar el error de longitud
    ...
    // SQL con solo campos básicos que sabemos que existen
    ...
    echo "<p>Código de empleado: " . $test_code . " (longitud: " . strlen($test_code) . ")</p>";
    echo "<p>SQL preparado con " . substr_count($sql, '?') . " placeholders</p>";
