...
if (isset($_GET['mis_datos']) && $_GET['mis_datos'] == 1) {
    ...
    if (isset($_POST['solicitud_permiso'])) {
        ...
        <p><a href="https://app.grupopcr.com.pa/app/views/aprobar_vacaciones.php?codigo_empleado=' . $codigo . '&nombre_completo=' . $nombre_comple . '&fecha_desde='.$fecha_inicio.'&fecha_hasta='.$fecha_fin.'$cantidad_dias='.$cantidad_dias.'">Aprobar o Declinar Solicitud de Permiso</a></p>
