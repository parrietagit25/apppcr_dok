    ...
    public function obtenerSolicitudesUnificadas() {
        $sql = "
            SELECT 
                ...
                c.file_add
            FROM calamidades c
            INNER JOIN empleados e ON e.codigo_empleado = c.code_user
            WHERE c.stat = 1
            ...
            SELECT 
                ...
                ct.file_add
            FROM carta_trabajo ct
            INNER JOIN empleados e ON e.codigo_empleado = ct.code_user
            WHERE ct.stat = 1
            ...
            INNER JOIN empleados e ON e.codigo_empleado = sp.code
            WHERE sp.stat = 1
