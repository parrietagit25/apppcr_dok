...
$mime_logo = mime_content_type($path_logo);
$mime_footer = mime_content_type($path_footer);

$img_logo_superior = 'data:' . $mime_logo . ';base64,' . base64_encode(file_get_contents($path_logo));
$img_logo_pie = 'data:' . $mime_footer . ';base64,' . base64_encode(file_get_contents($path_footer));
...
$dompdf->render();
$dompdf->stream("carta_trabajo.pdf", ["Attachment" => false]); // Mostrar en navegador
exit;
