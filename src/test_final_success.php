...
try {
    ...
    echo "<h3>Probando registro final con modelo User_simple:</h3>";
    ...
    echo "<p>Observaciones: Sin observaciones</p>";
    ...
    if ($result) {
        ...
        $stmt = $pdo->prepare("SELECT codigo_empleado, nombre, apellido, es_externo, ncodcia, nombre_departamento, nombre_cargo, observaciones FROM empleados WHERE codigo_empleado = ?");
