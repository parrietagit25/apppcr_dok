<?php
// Test que funciona incluyendo el campo observaciones
...
try {
    ...
    echo "<h3>Probando inserción incluyendo observaciones:</h3>";
    
    // SQL con todos los campos NOT NULL incluyendo observaciones
    ...
    echo "<p>SQL con 21 campos NOT NULL (incluyendo observaciones)</p>";
    ...
    if ($result) {
        ...
        $stmt = $pdo->prepare("SELECT codigo_empleado, nombre, apellido, es_externo, ncodcia, observaciones FROM empleados WHERE codigo_empleado = ?");
        ...
        if ($user) {
            ...
            echo "<p>Observaciones: " . $user['observaciones'] . "</p>";
        }
